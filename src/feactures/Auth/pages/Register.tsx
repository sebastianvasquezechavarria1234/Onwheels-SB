        ...
        <div className="flex flex-col lg:flex-row min-h-[700px]">
          ...
          <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center bg-slate-50">
            <div className="max-w-md mx-auto w-full">
              {/* <h1 className="text-3xl font-bold text-slate-800 mb-2">Comenzar</h1> */}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-800 hover:bg-red-600 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 shadow-lg hover:shadow-xl mt-6"
                >
                  Registrarse
                </button>
                ...
                <Link to="/login" className="text-blue-800 hover:text-red-600 font-medium transition-colors">
                  Iniciar sesión
                </Link>
              </p>
              </form>
