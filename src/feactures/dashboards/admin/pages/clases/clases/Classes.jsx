// src/features/dashboards/admin/pages/clases/clases/Clases.jsx
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-5 text-center">
                {modal === "crear" ? "Registrar Clase" : "Editar Clase"}
              </h3>
              ...
              <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onBlur={handleBlur}
                    className={`w-full p-2.5 border rounded-lg ${
                      formErrors.id_nivel ? "border-red-500" : "border-gray-300"
                    } focus:ring-2 focus:ring-blue-100 outline-none`}
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onBlur={handleBlur}
                    className={`w-full p-2.5 border rounded-lg ${
                      formErrors.dia_semana ? "border-red-500" : "border-gray-300"
                    } focus:ring-2 focus:ring-blue-100 outline-none`}
                  >
                    <option value="">Seleccionar...</option>
                  ...
                  <div className={`p-3 bg-gray-50 border rounded-lg ${formErrors.instructores ? "border-red-500" : "border-gray-200"}`}>
                    <div className="flex gap-2 mb-3">
                      <select
                        ...
                        value={form.instructorTemporal}
                        onChange={handleChange}
                        className="flex-1 text-sm bg-white border border-gray-300 rounded-lg px-2 py-2 outline-none"
                      >
                        <option value="">Seleccionar instructor...</option>
                        {instructores
                          .filter(i => !form.instructores.find(fi => fi.id_instructor == i.id_instructor))
                          .map(i => (
                    ...
                    <div className="flex flex-wrap gap-2">
                      {form.instructores.length === 0 && (
                        <span className="text-xs text-gray-400 italic">Sin instructores asignados</span>
                      )}
                      {form.instructores.map((inst, idx) => (
                        <div
                          key={idx}
                          className="bg-white border border-gray-200 text-xs font-medium px-2 py-1.5 rounded-md flex items-center gap-2 shadow-sm"
                        >
                          <User size={12} className="text-blue-500" />
                          {getNombreInstructor(inst.id_instructor)}
                          <button
                            type="button"
                            onClick={() => handleEliminarInstructor(idx)}
                ...
                <div className="md:col-span-2 flex justify-end gap-3 mt-4 pt-4 border-t border-gray-100">
                  ...
                  >
                    {modal === "crear" ? "Guardar Clase" : "Actualizar Clase"}
                  </button>
                </div>
              </form>
            </motion.div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-xs">
                        {selectedClase.hora_inicio?.substring(0, 5)} - {selectedClase.hora_fin?.substring(0, 5)}
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="w-full">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedClase.instructores?.map((inst, i) => (
                        <span
                          key={i}
                          className="bg-gray-100 text-gray-700 px-2 py-1 rounded-md text-xs font-medium border border-gray-200"
                        >
