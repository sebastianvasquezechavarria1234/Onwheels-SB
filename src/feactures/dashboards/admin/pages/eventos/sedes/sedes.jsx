                    ...
                    <div className={configUi.modalHeader}>
                      <div>
                        <h3 className={configUi.modalTitle}>
                          {modal === "add" ? "Registrar Nueva Sede" :
                            modal === "edit" ? "Editar Sede" :
                              modal === "details" ? "Detalles de Sede" : "Eliminar Sede"}
                        </h3>
                        <p className={configUi.modalSubtitle}>
                          {modal === "delete" ? "Confirme si desea remover esta ubicación de forma permanente." : 
                           modal === "details" ? "Resumen completo de la ubicación seleccionada." :
                           "Complete la información técnica de la ubicación física."}
                        </p>
                      </div>
