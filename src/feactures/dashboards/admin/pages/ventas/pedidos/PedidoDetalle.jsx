      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4 space-y-8">
           ...
           <div className="bg-[#16315f] rounded-[2.5rem] p-10 text-white shadow-2xl relative overflow-hidden group">
              <div className="absolute -bottom-8 -right-8 text-white/5 opacity-40 group-hover:scale-105 transition-transform duration-1000">
                 <CreditCard size={180} strokeWidth={0.5} />
              </div>
              
              <h3 className="text-base font-black uppercase tracking-[0.2em] mb-10 flex items-center gap-3">
              ...
              <div className="space-y-6 relative">
                 <div className="flex justify-between items-center text-white/40">
                    <span className="text-[10px] font-black uppercase tracking-widest">Pasarela</span>
                    <span className="px-3 py-1 bg-white/10 rounded-full text-[9px] font-black tracking-widest border border-white/5 uppercase">CONTRA-ENTREGA</span>
                 </div>
                 
                 <div className="pt-6 border-t border-white/5 flex flex-col gap-2">
                    <p className="text-[9px] font-black text-indigo-300 uppercase tracking-widest leading-none">Monto Neto</p>
                    <div className="flex justify-between items-end">
                       <span className="text-sm font-black flex items-center gap-2 text-emerald-400">
                          <CheckCircle size={16} /> VALIDADO
                       </span>
                       <span className="text-3xl font-black tracking-tighter tabular-nums">${Number(pedido.total).toLocaleString('es-CO')}</span>
                    </div>
                 </div>
              </div>
           </div>
           ...
           <button 
             onClick={() => navigate(`${basePath}/pedidos`)}
             className="w-full h-14 bg-white border border-[#d7e5f8] rounded-2xl text-[10px] font-black text-[#16315f] uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-[#fbfdff] hover:shadow-lg transition-all"
           >
              Panel de Control <ChevronRight size={16} className="text-indigo-400" />
           </button>
        </div>
      </div>
    </div>
