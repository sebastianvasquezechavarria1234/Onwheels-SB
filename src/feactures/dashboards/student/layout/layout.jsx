...
import { ArrowLeft, LogOut, Menu, School, Settings, ShoppingBag, X } from "lucide-react";
  ...
  const SidebarContent = () => (
    <>
      ...
      <div className="flex flex-col justify-between h-[83%]">
        <ul>
          <li>
            <BtnSideBar title="Mi cuenta" link="../student/setting" onClick={() => setSidebarOpen(false)}>
              <Settings size={20} strokeWidth={1.5}/>
            </BtnSideBar>
          </li>

          <li>
            <BtnSideBar title="Mis clases" link="../student/myClasses" onClick={() => setSidebarOpen(false)}>
              <School size={20} className="text-black/70" strokeWidth={1.5}/>
            </BtnSideBar>
          </li>
          <li>
            <BtnSideBar title="Mis compras" link="../student/myPurchases" onClick={() => setSidebarOpen(false)}>
