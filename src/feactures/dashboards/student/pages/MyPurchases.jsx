                    ...
                    {compras.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            {compras.map((c, index) => (
                                <article
                                    key={c.id_venta}
                                    className="bg-[#121821] border border-gray-800 rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-[#1E3A8A]/50 hover:shadow-2xl transition-all cursor-pointer group"
                                    onClick={() => navigate(`/student/myPurchases/${c.id_venta}`)}
                                >
                                    <div className="flex items-center gap-6 md:w-1/3">
                                        <div className="w-16 h-16 bg-[#0B0F14] rounded-xl flex items-center justify-center border border-gray-800 flex-shrink-0 group-hover:bg-[#1E3A8A]/10 group-hover:border-[#1E3A8A]/30 transition-colors">
                                    ...
                                    <div className="flex justify-end md:w-20">
                                        <div className="w-10 h-10 rounded-full bg-[#0B0F14] border border-gray-800 flex items-center justify-center group-hover:bg-[#1E3A8A] group-hover:border-[#1E3A8A] transition-all shadow-lg active:scale-95">
