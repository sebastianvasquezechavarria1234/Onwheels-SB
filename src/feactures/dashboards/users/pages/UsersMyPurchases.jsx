        ...
        <Layout>
            <section className="relative w-full bg-[var(--gray-bg-body)] side_bar">
                 <div className="flex justify-between items-center">
                    ...
                    <BtnLinkIcon title="Ir a la tienda" link="../users/store" style="bg-[var(--color-blue)]! text-white pr-[25px] m-[30px] max-md:pr-[15px]" styleIcon="bg-white!">
...
export default UsersMyPurchases;
