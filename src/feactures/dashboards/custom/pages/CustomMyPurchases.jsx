...
import { ShoppingBag, Calendar, Package, ChevronRight, Shirt } from "lucide-react";
import { Link, useNavigate } from "react-router-dom";
import api from "../../../../services/api";
import { cn } from "../../admin/pages/configuracion/configUi";
...
export const CustomMyPurchases = () => {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-[#0B0F14] flex items-center justify-center pt-[160px]">
    ...
    return (
        <section className="min-h-screen bg-[#0B0F14] text-white font-primary pt-[160px] pb-24">
