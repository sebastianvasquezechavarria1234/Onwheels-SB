								...
								<div className="space-y-6 mb-8 text-sm">
									...
									<div className="grid grid-cols-2 gap-x-8 gap-y-6 bg-gray-50 p-6 rounded-2xl border border-gray-100">
										...
										<div className="flex items-start gap-3 col-span-2">
											...
											<div>
												<p className="text-gray-500 uppercase font-bold tracking-widest text-[10px] mb-1">Estudiantes Inscritos</p>
												<p className="font-semibold text-gray-900">{selected.cantidadEstudiantes} Estudiantes en total para esta clase</p>
											</div>
										</div>
									</div>
								</div>
