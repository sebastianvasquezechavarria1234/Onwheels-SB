...
export const StudentClass = () => {
  ...
  // Fetch matrículas del estudiante
  useEffect(() => {
          ...
          <footer id="contacto" className="relative bg-gradient-to-br from-primary via-primary/90 to-secondary text-primary-foreground py-20 text-center overflow-hidden">
            ...
            <div className="container bg-blue-900 gap-10 p-20 mx-auto px-6 relative">
              <div className="max-w-3xl mx-auto">
                <h2 className="text-4xl md:text-5xl font-bold mb-6 text-balance text-amber-50">¿Listo para comenzar tu aventura?</h2>
                <p className="mb-8 text-xl leading-relaxed text-white">Preincríbete ahora y asegura tu cupo en la próxima clase. ¡Tu tabla te está esperando!</p>
                <div className="flex flex-col sm:flex-row gap-7 justify-center">
                  ...
                  <button className="border-2 border-white text-white hover:bg-red-800 px-10 py-4 rounded-xl font-semibold text-lg transition-all duration-300">Más información</button>
                </div>
              </div>
            </div>
          </footer>
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/10">
            ...
            <div className="container mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center relative">
              <div className="slide-in-up">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="bg-blue-900 hover:bg-primary/90 text-primary-foreground px-8 py-4 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 pulse-glow text-white">Quiero unirme</button>
                  <button className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300">Ver horarios</button>
                </div>
              </div>
              ...
              <div className="flex justify-center">
                <div className="relative w-full max-w-2xl h-[380px] md:h-[420px] overflow-hidden rounded-3xl shadow-2xl float-animation">
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/20 to-transparent z-10" />
                  <img src={carouselImages[current] || "/placeholder.svg"} alt="Skate carrusel" className="w-full h-full object-cover transition-all duration-700 hover:scale-105" />
                  <div className="absolute bottom-6 left-0 right-0 flex justify-center gap-3 z-20">
                    {carouselImages.map((_, idx) => (
                      <button key={idx} onClick={() => setCurrent(idx)}
                        className={`w-3 h-3 rounded-full transition-all duration-300 ${current === idx ? "bg-primary scale-125 shadow-lg" : "bg-white/50 hover:bg-white/80"}`} />
