          ...
          <article className="p-[30px] border-1 border-black/20 rounded-[30px] max-md:p-[15px]">
            ...
            <div className="mt-[24px] flex gap-3 flex-wrap">
              <BtnLinkIcon
                ...
                style="bg-[var(--color-blue)]! text-white px-[18px] py-[12px] rounded-[12px]"
                styleIcon="bg-white!"
              ...
              <button
                ...
                className="px-[18px] py-[12px] rounded-[12px] border hover:shadow-sm"
              >
                Seguir comprando
              </button>

              <a href={invoiceUrl} download className="px-[18px] py-[12px] rounded-[12px] border flex items-center gap-2">
                <DownloadCloud className="w-4 h-4" />
