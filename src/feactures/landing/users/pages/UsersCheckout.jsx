...
import { getHomePath, getStoreHomePath, getCartPath, getPurchasesPath, getUserRoleSlug } from "../../../../utils/roleHelpers";
    ...
    return (
      <UsersLayout>
        <div className="pt-24 min-h-screen flex flex-col items-center justify-center bg-[#0B0F14] text-white">
          ...
          <button onClick={() => navigate(getCartPath(user))} className="text-[#1E3A8A] hover:underline font-bold">
            Volver al carrito
          </button>
        </div>
      </UsersLayout>
      ...
      <div className="bg-[#0B0F14] min-h-screen text-white font-primary pb-24">
        <section className="pt-[120px] max-w-7xl mx-auto px-4 sm:px-6 flex gap-10 max-lg:flex-col">
          <div className="w-[65%] max-lg:w-full">
            <div className="mb-6">
              <button
                onClick={() => navigate(getCartPath(user))}
