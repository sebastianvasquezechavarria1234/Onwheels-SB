...
const UsersPreinscriptions = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Validar datos de tercero si aplica
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        // Solo enviar nuevoAcudiente si es Menor (independiente de si es PROPIA o TERCERO)
        ...(edadNum < 18 && {
            ...
            {!showConfirm && !showFinal ? (
              <div className="bg-zinc-900/40 rounded-[2rem] border border-zinc-800 p-8 backdrop-blur-xl">
                ...
                <form onSubmit={handleSubmit}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => setFormData(prev => ({
                                ...prev,
                                datos_tercero: { ...prev.datos_tercero, tipo_documento: e.target.value }
                              }))}
                              required
                            >
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setFormData(prev => ({
                                ...prev,
                                datos_tercero: { ...prev.datos_tercero, documento: e.target.value }
                              }))}
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setFormData(prev => ({
                              ...prev,
                              datos_tercero: { ...prev.datos_tercero, telefono: e.target.value }
                            }))}
                            required
                          />
                        </div>
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) => setFormData(prev => ({
                              ...prev,
                              datos_tercero: { ...prev.datos_tercero, genero: e.target.value }
                            }))}
                            required
                          >
                  ...
                  {/* Solo mostrar Acudiente si es Menor */}
                  {isMinor && (
              ...
              <div className="bg-zinc-900/40 rounded-[2rem] border border-zinc-800 p-8 backdrop-blur-xl">
                ...
                <div className="flex justify-between w-full mt-8 space-x-4">
                  ...
                  <button
                    type="button"
                    className="flex-1 bg-white text-black font-bold py-3 px-4 rounded-full hover:bg-[var(--color-blue)] hover:text-white transition-all uppercase tracking-wider text-sm flex items-center justify-center gap-2"
