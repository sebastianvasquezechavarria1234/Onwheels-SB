...
export const ProductDetailsContent = () => {
  ...
  // Simple image selection: show primary image or fallback
  const displayImage = imagen_producto && imagen_producto.length > 0 ? imagen_producto : "/bg_hero_shop.jpg";
...
// Exportar alias para las rutas que importan esos nombres desde AppRouter
export const PublicProductDetail = ProductDetailsContent;
export const AdminProductDetail = ProductDetailsContent;
export const StudentProductDetail = ProductDetailsContent;
export const InstructorProductDetail = ProductDetailsContent;
export const UserProductDetail = ProductDetailsContent;
export const CustomProductDetail = ProductDetailsContent;
