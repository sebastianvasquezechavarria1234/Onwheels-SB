...
import { ArrowRight, Icon,  NotebookPen, ShirtIcon } from "lucide-react";
			...
			<section className="max-w-[1400px] mx-auto h-[600px] flex gap-x-20 items-center p-[3rem]">
				...
				<div className="w-[50%]">
					<h2 className="text-4xl font-bold mb-4">
						¿Te 
						<span className="font-primary"> gustaría</span>
						<h2>aprender con</h2>
